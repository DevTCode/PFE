...
<br><br>
<router-link :to="{name: 'AddTypeVoiture'}" class="custom-link">  <v-row class="my-custom-class" justify="center"><button class="main-btn"> Add Type of car <i class="fas fa-shopping-basket ps-3"></i></button></v-row></router-link>
</div>
<br><br><br><br>
<table class="table">
  <thead>
