...
<router-link :to="{name: 'TypeVoitureList'}" class="custom-link"><a href="#" class="list-group-item list-group-item-action bg-transparen second-text fw-bold" style="color:#950101;background-color:white"><i class="bi bi-text-paragraph"></i><i class="fas fa-align-left primary-text fs-4 me-3" id="menu-toggle"></i>Types de Voiture</a></router-link>
...
<br>
<h3 class="cr">All Engine types</h3>
<br><br>

<router-link :to="{name: 'AddTypeMoteur'}" class="custom-link">  <v-row class="my-custom-class" justify="center"><button class="main-btn"> Add Brand <i class="fas fa-shopping-basket ps-3"></i></button></v-row></router-link>
</div>
<br><br>
<table class="table" align="center" style="display: table;
  ...
  <tbody>
    <tr v-for="item in items" :key="item.id">
        ...
        <router-link :to="{name: 'EditTypeVoiture' , params:{id:item.id}}"> <v-btn variant="flat" color="black"><i class="bi bi-pencil-square"></i>Edit</v-btn></router-link>
        </td>
      </tr>
  </tbody>
</table>
