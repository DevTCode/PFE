...
<br><br><br>
<h3 class="cr">Liste des marques</h3>
<br>

<router-link :to="{name: 'AddMarque'}" class="custom-link" style="color:white">  <v-row class="my-custom-class" justify="center"><button class="main-btn"> Ajouter marque <i class="fas fa-shopping-basket ps-3"></i></button></v-row></router-link>
</div>
<br><br>
<table class="table" align="center" style="display: table;
  margin: auto;width:70%;margin-right: 190px;height=20px;border: 2px solid white;background-color:black;opacity:80%">
  <thead>
    <tr>
  ...
  <tbody>
    <tr v-for="item in items" :key="item.id">
        ...
        <router-link :to="{name: 'Editmarque' , params:{id:item.id}}"  style="color:white"> <v-btn variant="flat" color="white"><i class="bi bi-pencil-square"></i>Edit</v-btn></router-link>
        </td>
      </tr>
  </tbody>
</table>
...
<div class="text-center">
   ...
   <i class="bi bi-chevron-left" style="color:red;font-weight:600;font-size:19px"></i><div class="btn-group me-2" role="group" aria-label="First group">
       <router-link :to="{name:'MarqueList'}" style="color:black"><v-btn>1</v-btn></router-link>
   </div>
   <div class="btn-group me-2" role="group" aria-label="Second group">
       <router-link :to="{name:'m'}" style="color:black"><v-btn>2</v-btn></router-link>
